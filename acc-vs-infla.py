...
try:
    if ticker:
        ...
        if df.empty:
            ...
            generar_grafico(ticker, df, cumulative_inflation, year=datetime.today().year if analysis_type == 'Por año (predeterminado)' else None)

except Exception as e:
    st.error(f"Se produjo un error al recuperar los datos: {e}")
